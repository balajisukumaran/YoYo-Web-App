...
using YoYoWebApp.Data.Services.FitnessRatings;
using YoYoWebApp.Data.Services.Athletes;
...
namespace YoYo_Web_App.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        public InMemoryFitnessRating objFitnessRating;
        public InMemoryAthletes objAthletes;
        public HomeController(ILogger<HomeController> logger)
        {
            _logger = logger;
            objFitnessRating = new InMemoryFitnessRating();
            objAthletes = new InMemoryAthletes();
